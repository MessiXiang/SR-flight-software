...
class Payload03old(Node):
    def __init__(self,name):
        ...
        self.add_ints_server_ = self.create_service(Md5ver, "md5ver_srv31old", self.hash_calc_md5)
    ...
    def command_callback_break(self, msg):
        if msg.data == 999:
            ...
            self.destroy_service(self.add_ints_server_)
            rclpy.shutdown()
...
def main(args=None):
    ...
    node = Payload03old("payload03old")
    rclpy.spin(node)
    rclpy.shutdown()